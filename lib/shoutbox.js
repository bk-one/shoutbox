...
Shoutbox.prototype.updateStatusOnShoutbox = function( shoutboxId, shoutbox, updateData, status ) {
  this.db.collection('shoutboxes', function(err, collection) {
    ...
    shoutbox.groups[updateData.group][updateData.name] = { status: updateData.status }
...
Shoutbox.prototype.deleteStatusOnShoutbox = function( shoutboxId, shoutbox, updateData, status ) {
}
